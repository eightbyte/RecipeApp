...
public static class DataSeeder
{
    ...
    [
        new("pasta",            "Pasta",            IngredientCategory.PastaSauces,  "g"),
        ...
        new("dried oregano",    "Dried Oregano",    IngredientCategory.BakingSpices, "tsp"),
        new("olive oil",        "Olive Oil",        IngredientCategory.Condiments,   "tbsp"),
        new("salt",             "Salt",             IngredientCategory.BakingSpices, "tsp"),
        new("black pepper",     "Black Pepper",     IngredientCategory.BakingSpices, "tsp"),
        ...
        new("honey",            "Honey",            IngredientCategory.JamNutButter, "tbsp"),
        new("rice",             "Rice",             IngredientCategory.GrainsRice,   "g"),
    ];
